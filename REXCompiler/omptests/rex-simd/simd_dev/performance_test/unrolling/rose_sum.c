...
float sum(float *X)
{
  ...
  for (i = 0; i <= 119999; i += 80) {
    __m512 __vec1 = _mm512_loadu_ps(&X[i]);
    __m512 __vec2 = _mm512_add_ps(__vec1,__vec0);
    __part3 = _mm512_add_ps(__part3,__vec2);
{
      __m512 __vec1 = _mm512_loadu_ps(&X[i + 16]);
      __m512 __vec2 = _mm512_add_ps(__vec1,__vec0);
      __part3 = _mm512_add_ps(__part3,__vec2);
    }
{
      __m512 __vec1 = _mm512_loadu_ps(&X[i + 32]);
      __m512 __vec2 = _mm512_add_ps(__vec1,__vec0);
      __part3 = _mm512_add_ps(__part3,__vec2);
    }
{
      __m512 __vec1 = _mm512_loadu_ps(&X[i + 48]);
      __m512 __vec2 = _mm512_add_ps(__vec1,__vec0);
      __part3 = _mm512_add_ps(__part3,__vec2);
    }
{
      __m512 __vec1 = _mm512_loadu_ps(&X[i + 64]);
      __m512 __vec2 = _mm512_add_ps(__vec1,__vec0);
      __part3 = _mm512_add_ps(__part3,__vec2);
    }
  }
...
//Set everything up
  ...
  puts("---------------------------------");
  printf("Serial: %f\n",result_serial);
  double gflops = 2.0 * 120000 * 120000 * 10000 / (1.0e9 * t);
  double gflops_serial = 2.0 * 120000 * 120000 * 10000 / (1.0e9 * t_serial);
  printf("==================================================================\n");

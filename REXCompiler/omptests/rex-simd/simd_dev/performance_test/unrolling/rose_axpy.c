...
{
      __m512 __vec0 = _mm512_loadu_ps(&Y[i + 16]);
      __m512 __vec2 = _mm512_loadu_ps(&X[i + 16]);
      __m512 __vec3 = _mm512_mul_ps(__vec2,__vec1);
      __m512 __vec4 = _mm512_add_ps(__vec3,__vec0);
      _mm512_storeu_ps(&Y[i + 16],__vec4);
    }
{
      __m512 __vec0 = _mm512_loadu_ps(&Y[i + 32]);
      __m512 __vec2 = _mm512_loadu_ps(&X[i + 32]);
      __m512 __vec3 = _mm512_mul_ps(__vec2,__vec1);
      __m512 __vec4 = _mm512_add_ps(__vec3,__vec0);
      _mm512_storeu_ps(&Y[i + 32],__vec4);
    }
{
      __m512 __vec0 = _mm512_loadu_ps(&Y[i + 48]);
      __m512 __vec2 = _mm512_loadu_ps(&X[i + 48]);
      __m512 __vec3 = _mm512_mul_ps(__vec2,__vec1);
      __m512 __vec4 = _mm512_add_ps(__vec3,__vec0);
      _mm512_storeu_ps(&Y[i + 48],__vec4);
    }
{
      __m512 __vec0 = _mm512_loadu_ps(&Y[i + 64]);
      __m512 __vec2 = _mm512_loadu_ps(&X[i + 64]);
      __m512 __vec3 = _mm512_mul_ps(__vec2,__vec1);
      __m512 __vec4 = _mm512_add_ps(__vec3,__vec0);
      _mm512_storeu_ps(&Y[i + 64],__vec4);
    }
  }
}
// Debug functions
...
//Set everything up
  ...
  double gflops = 2.0 * 1200 * 1200 * 10000 / (1.0e9 * t);
  double gflops_serial = 2.0 * 1200 * 1200 * 10000 / (1.0e9 * t_serial);
  printf("==================================================================\n");

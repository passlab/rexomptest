...
void matmul_simd(float **A,float **B,float **C)
{
  ...
  for (i = 0; i < 512; i++) {
    for (j = 0; j < 512; j++) {
      ...
      for (k = 0; k <= 511 - _lu_fringe_1; k += 80) {
        float *__ptr1 = A[i];
...
{
          float *__ptr1 = A[i];
          __m512 __vec2 = _mm512_loadu_ps(&__ptr1[k + 16]);
          float *__ptr3 = B[j];
          __m512 __vec4 = _mm512_loadu_ps(&__ptr3[k + 16]);
          __m512 __vec5 = _mm512_mul_ps(__vec4,__vec2);
          __m512 __vec6 = _mm512_add_ps(__vec5,__vec0);
          __part7 = _mm512_add_ps(__part7,__vec6);
        }
{
          float *__ptr1 = A[i];
          __m512 __vec2 = _mm512_loadu_ps(&__ptr1[k + 32]);
          float *__ptr3 = B[j];
          __m512 __vec4 = _mm512_loadu_ps(&__ptr3[k + 32]);
          __m512 __vec5 = _mm512_mul_ps(__vec4,__vec2);
          __m512 __vec6 = _mm512_add_ps(__vec5,__vec0);
          __part7 = _mm512_add_ps(__part7,__vec6);
        }
{
          float *__ptr1 = A[i];
          __m512 __vec2 = _mm512_loadu_ps(&__ptr1[k + 48]);
          float *__ptr3 = B[j];
          __m512 __vec4 = _mm512_loadu_ps(&__ptr3[k + 48]);
          __m512 __vec5 = _mm512_mul_ps(__vec4,__vec2);
          __m512 __vec6 = _mm512_add_ps(__vec5,__vec0);
          __part7 = _mm512_add_ps(__part7,__vec6);
        }
{
          float *__ptr1 = A[i];
          __m512 __vec2 = _mm512_loadu_ps(&__ptr1[k + 64]);
          float *__ptr3 = B[j];
          __m512 __vec4 = _mm512_loadu_ps(&__ptr3[k + 64]);
          __m512 __vec5 = _mm512_mul_ps(__vec4,__vec2);
          __m512 __vec6 = _mm512_add_ps(__vec5,__vec0);
          __part7 = _mm512_add_ps(__part7,__vec6);
        }

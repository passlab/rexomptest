...
// %bb.2:
	...
	cntw	x16
	scvtf	d12, w17
	whilelo	p3.s, xzr, x10
	lsl	x17, x8, #2
	mov	z17.s, s10
	mov	z18.s, s11
	mov	z19.s, s2
	cmpeq	p4.s, p2/z, z5.s, z1.s
...
.LBB1_8:                                //   Parent Loop BB1_3 Depth=1
                                        ...
                                        // =>    This Inner Loop Header: Depth=3
	sxtw	x3, w0
	ld1w	{ z0.s }, p1/z, [x2, x3, lsl #2]
	st1w	{ z0.s }, p1, [x1, x3, lsl #2]
	whilelt	p1.s, w0, w9
	add	w0, w0, w16
	cmp	w0, w22
	b.lt	.LBB1_8
...
.LBB1_15:                               //   Parent Loop BB1_3 Depth=1
                                        ...
                                        // =>    This Inner Loop Header: Depth=3
	ld1w	{ z4.s }, p0/z, [x3, x0, lsl #2]
	ld1w	{ z5.s }, p0/z, [x2, x0, lsl #2]
	ld1w	{ z6.s }, p0/z, [x1, x0, lsl #2]
	ld1w	{ z7.s }, p0/z, [x4, x0, lsl #2]
	lastb	s3, p2, z3.s
	fadd	z4.s, z4.s, z5.s
	fmul	z4.s, z17.s, z4.s
	fadd	z5.s, z6.s, z7.s
	movprfx	z6, z7
	insr	z6.s, s3
	fmul	z3.s, z18.s, z5.s
	ld1w	{ z5.s }, p0/z, [x6, x0, lsl #2]
	fadd	z3.s, z4.s, z3.s
	fmul	z4.s, z6.s, z19.s
	fadd	z3.s, z4.s, z3.s
	fsub	z3.s, z3.s, z5.s
	fdiv	z3.s, p0/m, z3.s, z19.s
	fmul	z4.s, z3.s, z16.s
	fsub	z4.s, z6.s, z4.s
	fmul	z3.s, z3.s, z3.s
	st1w	{ z4.s }, p0, [x5, x0, lsl #2]
	incw	x0
	fadda	s1, p0, s1, z3.s
	whilelo	p0.s, x0, x10
	mov	z3.d, z7.d
...
.LBB1_22:                               //   in Loop: Header=BB1_3 Depth=1
	str	x8, [x29, #72]                  // 8-byte Folded Spill
	addvl	x8, x29, #-6
	stur	w9, [x8, #-28]                  // 4-byte Folded Spill
	addvl	x8, x29, #-6
	stur	x10, [x8, #-8]                  // 8-byte Folded Spill
	addvl	x8, x29, #-6
	mov	v0.16b, v1.16b
	str	x11, [sp, #24]                  // 8-byte Folded Spill
	stur	x12, [x8, #-16]                 // 8-byte Folded Spill
	addvl	x8, x29, #-6
	str	x13, [sp, #16]                  // 8-byte Folded Spill
	stur	x14, [x8, #-24]                 // 8-byte Folded Spill
	stp	x17, x15, [sp]                  // 16-byte Folded Spill
	mov	v13.16b, v2.16b
	str	z16, [x29, #-1, mul vl]         // 16-byte Folded Spill
	str	p3, [x29, #-9, mul vl]          // 2-byte Folded Spill
	str	z17, [x29, #-3, mul vl]         // 16-byte Folded Spill
	str	z18, [x29, #-4, mul vl]         // 16-byte Folded Spill
	str	z19, [x29, #-5, mul vl]         // 16-byte Folded Spill
	str	p4, [x29, #-41, mul vl]         // 2-byte Folded Spill
	bl	sqrt
	addvl	x8, x29, #-6
	ldr	p4, [x29, #-41, mul vl]         // 2-byte Folded Reload
	ldr	z19, [x29, #-5, mul vl]         // 16-byte Folded Reload
	ldr	z18, [x29, #-4, mul vl]         // 16-byte Folded Reload
	ldr	z17, [x29, #-3, mul vl]         // 16-byte Folded Reload
	ldr	p3, [x29, #-9, mul vl]          // 2-byte Folded Reload
	ldr	z16, [x29, #-1, mul vl]         // 16-byte Folded Reload
	ldur	x14, [x8, #-24]                 // 8-byte Folded Reload
	addvl	x8, x29, #-6
	ldur	x12, [x8, #-16]                 // 8-byte Folded Reload
	addvl	x8, x29, #-6
	ldur	x10, [x8, #-8]                  // 8-byte Folded Reload
	addvl	x8, x29, #-6
	ldp	x17, x15, [sp]                  // 16-byte Folded Reload
	ldp	x13, x11, [sp, #16]             // 16-byte Folded Reload
	ldur	w9, [x8, #-28]                  // 4-byte Folded Reload
	ldr	x8, [x29, #72]                  // 8-byte Folded Reload
	ptrue	p2.s
	mov	v2.16b, v13.16b
	cntw	x16
	b	.LBB1_20

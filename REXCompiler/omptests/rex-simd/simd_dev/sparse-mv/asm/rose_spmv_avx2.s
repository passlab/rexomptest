...
.LBB2_44:                               # %for.end119
	...
	vmovss	dword ptr [r15 + 4*rax], xmm1
	mov	edx, ebp
	mov	rax, r9
	cmp	r9, r8
	je	.LBB2_45
...
.LBB2_43:                               # %for.body102
	...
	vgatherdps	ymm6, ymmword ptr [rcx + 4*ymm4], ymm5
	vmulps	ymm4, ymm6, ymmword ptr [rbx + 4*rdx]
	...
	jl	.LBB2_43
	jmp	.LBB2_44
.LBB2_45:                               # %for.end134.loopexit
	vcvtsi2sd	xmm0, xmm7, esi
	jmp	.LBB2_46
.LBB2_39:
	vxorpd	xmm0, xmm0, xmm0
.LBB2_46:                               # %for.end134
	...
	vzeroupper
	call	ftime
	vcvtsi2sd	xmm0, xmm7, qword ptr [rsp + 40]
	movzx	eax, word ptr [rsp + 48]
	vcvtsi2sd	xmm1, xmm7, eax
	vdivsd	xmm1, xmm1, qword ptr [rip + .LCPI2_1]
	vaddsd	xmm0, xmm1, xmm0
...
# %bb.52:                               # %vector.ph359.new
	...
	.p2align	4, 0x90
.LBB2_53:                               # %vector.body357
                                        # =>This Inner Loop Header: Depth=1
	vmovups	ymm5, ymmword ptr [r15 + 4*rdi]
	vmovups	ymm6, ymmword ptr [r15 + 4*rdi + 32]
	vmovups	ymm7, ymmword ptr [r15 + 4*rdi + 64]
	vmovups	ymm8, ymmword ptr [r15 + 4*rdi + 96]
	...
	vmovups	ymm5, ymmword ptr [r15 + 4*rdi + 128]
	vmovups	ymm6, ymmword ptr [r15 + 4*rdi + 160]
	vmovups	ymm7, ymmword ptr [r15 + 4*rdi + 192]
	vmovups	ymm8, ymmword ptr [r15 + 4*rdi + 224]
	vcmpltps	ymm5, ymm5, ymm4
	vpsubd	ymm0, ymm0, ymm5
	vcmpltps	ymm5, ymm6, ymm4
	vpsubd	ymm1, ymm1, ymm5
	...
	add	rsi, 2
	jne	.LBB2_53
# %bb.54:                               # %middle.block355.unr-lcssa
	test	cl, 1
	je	.LBB2_56
.LBB2_55:                               # %vector.body357.epil
	vmovups	ymm4, ymmword ptr [r15 + 4*rdi]
	vmovups	ymm5, ymmword ptr [r15 + 4*rdi + 32]
	vmovups	ymm6, ymmword ptr [r15 + 4*rdi + 64]
	vmovups	ymm7, ymmword ptr [r15 + 4*rdi + 96]
...
.LBB2_56:                               # %middle.block355
	...
	cmp	rax, rdx
	je	.LBB2_59
.LBB2_57:                               # %for.body144.preheader375
	vpxor	xmm0, xmm0, xmm0
	.p2align	4, 0x90
.LBB2_58:                               # %for.body144
                                        # =>This Inner Loop Header: Depth=1
	xor	ecx, ecx
	vucomiss	xmm0, dword ptr [r15 + 4*rax]
	seta	cl
	add	esi, ecx
	inc	rax
	cmp	rdx, rax

...
.LBB2_45:                               # %vector.body321
	...
	vmovups	32(%r15,%rdi,4), %ymm6
	vmovups	64(%r15,%rdi,4), %ymm7
	vmovups	96(%r15,%rdi,4), %ymm8
	kxnorw	%k0, %k0, %k1
	vgatherdps	(%r12,%ymm5,4), %ymm9 {%k1}
	kxnorw	%k0, %k0, %k1
	vgatherdps	(%r12,%ymm6,4), %ymm5 {%k1}
	kxnorw	%k0, %k0, %k1
	vgatherdps	(%r12,%ymm7,4), %ymm6 {%k1}
	kxnorw	%k0, %k0, %k1
	vgatherdps	(%r12,%ymm8,4), %ymm7 {%k1}
	vmulps	(%rbx,%rdi,4), %ymm9, %ymm8
	vaddps	%ymm1, %ymm8, %ymm1
	vmulps	32(%rbx,%rdi,4), %ymm5, %ymm5
	vaddps	%ymm5, %ymm2, %ymm2
	vmulps	64(%rbx,%rdi,4), %ymm6, %ymm5
	vaddps	%ymm5, %ymm3, %ymm3
	vmulps	96(%rbx,%rdi,4), %ymm7, %ymm5
...
# %bb.46:                               # %middle.block319
	...
	cmpl	%esi, %ebp
	je	.LBB2_52
.LBB2_47:                               # %omp.inner.for.body.preheader372
                                        #   in Loop: Header=BB2_39 Depth=1
	movl	%edx, %ecx
	notl	%ecx
	addl	%eax, %ecx
...
.LBB2_49:                               # %omp.inner.for.body.prol.loopexit
	...
	cmpl	$3, %ecx
	jb	.LBB2_52
# %bb.50:                               # %omp.inner.for.body.preheader397
                                        #   in Loop: Header=BB2_39 Depth=1
	addl	%edx, %esi
	.p2align	4, 0x90
...
.LBB2_61:                               # %vector.body349
	...
	addq	$2, %rsi
	jne	.LBB2_61
# %bb.62:                               # %middle.block347.unr-lcssa
	testb	$1, %cl
	je	.LBB2_64
.LBB2_63:                               # %vector.body349.epil
...
.LBB2_64:                               # %middle.block347
	...
	cmpq	%r14, %rax
	je	.LBB2_67
.LBB2_65:                               # %for.body136.preheader371

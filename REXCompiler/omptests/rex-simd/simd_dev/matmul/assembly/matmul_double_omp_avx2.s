...
.LBB2_3:                                # %vector.body
	...
	vmovupd	(%r11,%rcx,8), %ymm5
	vmovupd	32(%r11,%rcx,8), %ymm6
	vmovupd	64(%r11,%rcx,8), %ymm7
	vmovupd	96(%r11,%rcx,8), %ymm8
	vmulpd	(%rax,%rcx,8), %ymm5, %ymm5
	vmulpd	32(%rax,%rcx,8), %ymm6, %ymm6
	vaddpd	%ymm5, %ymm1, %ymm1
	vaddpd	%ymm6, %ymm3, %ymm3
	vmulpd	64(%rax,%rcx,8), %ymm7, %ymm5
	vmulpd	96(%rax,%rcx,8), %ymm8, %ymm6
	vaddpd	%ymm5, %ymm2, %ymm2
	vaddpd	%ymm6, %ymm4, %ymm4
	vmovupd	128(%r11,%rcx,8), %ymm5
	vmovupd	160(%r11,%rcx,8), %ymm6
	vmovupd	192(%r11,%rcx,8), %ymm7
	vmovupd	224(%r11,%rcx,8), %ymm8
	vmulpd	128(%rax,%rcx,8), %ymm5, %ymm5
	vaddpd	%ymm5, %ymm1, %ymm1
	vmulpd	160(%rax,%rcx,8), %ymm6, %ymm5
	vaddpd	%ymm5, %ymm3, %ymm3
	vmulpd	192(%rax,%rcx,8), %ymm7, %ymm5
	vaddpd	%ymm5, %ymm2, %ymm2
	vmulpd	224(%rax,%rcx,8), %ymm8, %ymm5
...
.LBB6_17:                               # %vector.body
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	vmovupd	(%rcx,%rax,8), %ymm5
	vmovupd	32(%rcx,%rax,8), %ymm6
	vmovupd	64(%rcx,%rax,8), %ymm7
	vmovupd	96(%rcx,%rax,8), %ymm8
	vmulpd	(%rdi,%rax,8), %ymm5, %ymm5
	vmulpd	32(%rdi,%rax,8), %ymm6, %ymm6
	vaddpd	%ymm5, %ymm1, %ymm1
	vaddpd	%ymm6, %ymm3, %ymm3
	vmulpd	64(%rdi,%rax,8), %ymm7, %ymm5
	vmulpd	96(%rdi,%rax,8), %ymm8, %ymm6
	vaddpd	%ymm5, %ymm2, %ymm2
	vaddpd	%ymm6, %ymm4, %ymm4
	vmovupd	128(%rcx,%rax,8), %ymm5
	vmovupd	160(%rcx,%rax,8), %ymm6
	vmovupd	192(%rcx,%rax,8), %ymm7
	vmovupd	224(%rcx,%rax,8), %ymm8
	vmulpd	128(%rdi,%rax,8), %ymm5, %ymm5
	vaddpd	%ymm5, %ymm1, %ymm1
	vmulpd	160(%rdi,%rax,8), %ymm6, %ymm5
	vaddpd	%ymm5, %ymm3, %ymm3
	vmulpd	192(%rdi,%rax,8), %ymm7, %ymm5
	vaddpd	%ymm5, %ymm2, %ymm2
	vmulpd	224(%rdi,%rax,8), %ymm8, %ymm5
	vaddpd	%ymm5, %ymm4, %ymm4
	addq	$32, %rax
	cmpq	$1024, %rax                     # imm = 0x400
	jne	.LBB6_17
...
.LBB6_30:                               # %vector.body290
	...
	vmovupd	(%rsi,%rdx,8), %ymm6
	vmovupd	32(%rsi,%rdx,8), %ymm7
	vmovupd	64(%rsi,%rdx,8), %ymm8
	vmovupd	96(%rsi,%rdx,8), %ymm9
	vmulpd	(%rcx,%rdx,8), %ymm6, %ymm6
	vmulpd	32(%rcx,%rdx,8), %ymm7, %ymm7
	vaddpd	%ymm6, %ymm2, %ymm2
	vaddpd	%ymm7, %ymm4, %ymm4
	vmulpd	64(%rcx,%rdx,8), %ymm8, %ymm6
	vmulpd	96(%rcx,%rdx,8), %ymm9, %ymm7
	vaddpd	%ymm6, %ymm3, %ymm3
	vaddpd	%ymm7, %ymm5, %ymm5
	vmovupd	128(%rsi,%rdx,8), %ymm6
	vmovupd	160(%rsi,%rdx,8), %ymm7
	vmovupd	192(%rsi,%rdx,8), %ymm8
	vmovupd	224(%rsi,%rdx,8), %ymm9
	vmulpd	128(%rcx,%rdx,8), %ymm6, %ymm6
	vaddpd	%ymm6, %ymm2, %ymm2
	vmulpd	160(%rcx,%rdx,8), %ymm7, %ymm6
	vaddpd	%ymm6, %ymm4, %ymm4
	vmulpd	192(%rcx,%rdx,8), %ymm8, %ymm6
	vaddpd	%ymm6, %ymm3, %ymm3
	vmulpd	224(%rcx,%rdx,8), %ymm9, %ymm6

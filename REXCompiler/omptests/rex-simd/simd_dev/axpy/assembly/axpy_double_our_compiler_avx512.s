	.text
	.file	"rose_axpy_double_avx512.c"
...
.LBB2_1:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	vmulpd	64(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	64(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 64(%rsi,%rax,8)
	vmulpd	128(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	128(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 128(%rsi,%rax,8)
	vmulpd	192(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	192(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 192(%rsi,%rax,8)
	vmulpd	256(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	256(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 256(%rsi,%rax,8)
	vmulpd	320(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	320(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 320(%rsi,%rax,8)
	vmulpd	384(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	384(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 384(%rsi,%rax,8)
	vmulpd	448(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	448(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 448(%rsi,%rax,8)
	vmulpd	512(%rdi,%rax,8), %zmm0, %zmm1
	vaddpd	512(%rsi,%rax,8), %zmm1, %zmm1
	vmovupd	%zmm1, 512(%rsi,%rax,8)
	addq	$64, %rax
	cmpq	$102399992, %rax                # imm = 0x61A7FF8
	jb	.LBB2_1
# %bb.2:                                # %for.end
	vzeroupper
	retq
...
# %bb.2:                                # %for.body.preheader
	...
	callq	puts
	movq	$-8, %rax
	vbroadcastsd	.LCPI6_1(%rip), %zmm1   # zmm1 = [3.1400000000000001E+0,3.1400000000000001E+0,3.1400000000000001E+0,3.1400000000000001E+0,3.1400000000000001E+0,3.1400000000000001E+0,3.1400000000000001E+0,3.1400000000000001E+0]
	.p2align	4, 0x90
.LBB6_3:                                # %for.body.i116
                                        # =>This Inner Loop Header: Depth=1
	vmulpd	64(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	64(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 64(%r15,%rax,8)
	vmulpd	128(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	128(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 128(%r15,%rax,8)
	vmulpd	192(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	192(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 192(%r15,%rax,8)
	vmulpd	256(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	256(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 256(%r15,%rax,8)
	vmulpd	320(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	320(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 320(%r15,%rax,8)
	vmulpd	384(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	384(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 384(%r15,%rax,8)
	vmulpd	448(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	448(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 448(%r15,%rax,8)
	vmulpd	512(%r14,%rax,8), %zmm1, %zmm0
	vaddpd	512(%r15,%rax,8), %zmm0, %zmm0
	vmovupd	%zmm0, 512(%r15,%rax,8)
	addq	$64, %rax
	cmpq	$102399992, %rax                # imm = 0x61A7FF8
	jb	.LBB6_3
...
.LBB6_5:                                # %vector.body
	...
	cmpq	$102400028, %rax                # imm = 0x61A801C
	jne	.LBB6_5
# %bb.6:                                # %for.body.i149.preheader
	vmovupd	%ymm4, 160(%rsp)                # 32-byte Spill
	xorl	%r12d, %r12d
	.p2align	4, 0x90
.LBB6_7:                                # %for.body.i149
                                        # =>This Inner Loop Header: Depth=1
	vzeroupper
	callq	rand
...
# %bb.8:                                # %for.body14.preheader
	...
	.p2align	4, 0x90
.LBB6_9:                                # %for.body.i180.preheader
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB6_10 Depth 2
	movq	$-8, %rdx
	.p2align	4, 0x90
.LBB6_10:                               # %for.body.i180
                                        #   Parent Loop BB6_9 Depth=1
                                        # =>  This Inner Loop Header: Depth=2
	vmulpd	64(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	64(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 64(%r15,%rdx,8)
	vmulpd	128(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	128(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 128(%r15,%rdx,8)
	vmulpd	192(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	192(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 192(%r15,%rdx,8)
	vmulpd	256(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	256(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 256(%r15,%rdx,8)
	vmulpd	320(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	320(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 320(%r15,%rdx,8)
	vmulpd	384(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	384(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 384(%r15,%rdx,8)
	vmulpd	448(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	448(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 448(%r15,%rdx,8)
	vmulpd	512(%r14,%rdx,8), %zmm2, %zmm1
	vaddpd	512(%r15,%rdx,8), %zmm1, %zmm1
	vmovupd	%zmm1, 512(%r15,%rdx,8)
	addq	$64, %rdx
	cmpq	$102399992, %rdx                # imm = 0x61A7FF8
	jb	.LBB6_10
# %bb.11:                               # %axpy.exit181
...
# %bb.12:                               # %for.cond.cleanup27
	...
	.p2align	4, 0x90
.LBB6_13:                               # %vector.ph205
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB6_14 Depth 2
	movl	$28, %edx
	.p2align	4, 0x90
.LBB6_14:                               # %vector.body204

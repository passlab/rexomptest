...
.LBB6_18:                               //   Parent Loop BB6_17 Depth=1
	...
	ld1w	{ z1.s }, p0/z, [x19, x11, lsl #2]
	ld1w	{ z2.s }, p0/z, [x20, x11, lsl #2]
	fmad	z1.s, p1/m, z0.s, z2.s
	st1w	{ z1.s }, p0, [x20, x11, lsl #2]
	incw	x11
...
.LBB6_22:                               //   Parent Loop BB6_21 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	ld1w	{ z1.s }, p0/z, [x19, x11, lsl #2]
	ld1w	{ z2.s }, p0/z, [x21, x11, lsl #2]
	fmad	z1.s, p1/m, z0.s, z2.s
	st1w	{ z1.s }, p0, [x21, x11, lsl #2]
	incw	x11
	whilelo	p0.s, x11, x22
	b.mi	.LBB6_22

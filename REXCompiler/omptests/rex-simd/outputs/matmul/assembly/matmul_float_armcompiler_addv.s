...
.LBB5_2:                                //   Parent Loop BB5_1 Depth=1
                                        // =>  This Inner Loop Header: Depth=2
	ld1w	{ z2.s }, p2/z, [x11, x10, lsl #2]
	ld1w	{ z3.s }, p2/z, [x12, x10, lsl #2]
	incw	x10
	fadd	z2.s, z2.s, z0.s
	fsub	z2.s, z2.s, z3.s
	mov	z0.s, p2/m, z2.s
...
.LBB6_30:                               //   Parent Loop BB6_27 Depth=1
	...
	ld1w	{ z2.s }, p0/z, [x13, x16, lsl #2]
	ld1w	{ z3.s }, p0/z, [x17, x16, lsl #2]
	incw	x16
	fmla	z1.s, p0/m, z3.s, z2.s
	whilelo	p0.s, x16, x11
	b.mi	.LBB6_30

...
.LBB2_3:                                # %vector.body
	...
	vmovups	(%r11,%rcx,4), %ymm5
	vmovups	32(%r11,%rcx,4), %ymm6
	vmovups	64(%r11,%rcx,4), %ymm7
	vmovups	96(%r11,%rcx,4), %ymm8
	vmulps	(%rax,%rcx,4), %ymm5, %ymm5
	vmulps	32(%rax,%rcx,4), %ymm6, %ymm6
	vaddps	%ymm5, %ymm1, %ymm1
	vaddps	%ymm6, %ymm3, %ymm3
	vmulps	64(%rax,%rcx,4), %ymm7, %ymm5
	vmulps	96(%rax,%rcx,4), %ymm8, %ymm6
	vaddps	%ymm5, %ymm2, %ymm2
	vaddps	%ymm6, %ymm4, %ymm4
	vmovups	128(%r11,%rcx,4), %ymm5
	vmovups	160(%r11,%rcx,4), %ymm6
	vmovups	192(%r11,%rcx,4), %ymm7
	vmovups	224(%r11,%rcx,4), %ymm8
	vmulps	128(%rax,%rcx,4), %ymm5, %ymm5
	vaddps	%ymm5, %ymm1, %ymm1
	vmulps	160(%rax,%rcx,4), %ymm6, %ymm5
	vaddps	%ymm5, %ymm3, %ymm3
	vmulps	192(%rax,%rcx,4), %ymm7, %ymm5
	vaddps	%ymm5, %ymm2, %ymm2
	vmulps	224(%rax,%rcx,4), %ymm8, %ymm5
...
.LBB6_17:                               # %vector.body
	...
	vmovups	32(%rcx,%rax,4), %ymm6
	vmovups	64(%rcx,%rax,4), %ymm7
	vmovups	96(%rcx,%rax,4), %ymm8
	vmulps	(%rdi,%rax,4), %ymm5, %ymm5
	vmulps	32(%rdi,%rax,4), %ymm6, %ymm6
	vaddps	%ymm5, %ymm1, %ymm1
	vaddps	%ymm6, %ymm3, %ymm3
	vmulps	64(%rdi,%rax,4), %ymm7, %ymm5
	vmulps	96(%rdi,%rax,4), %ymm8, %ymm6
	vaddps	%ymm5, %ymm2, %ymm2
	vaddps	%ymm6, %ymm4, %ymm4
	vmovups	128(%rcx,%rax,4), %ymm5
	vmovups	160(%rcx,%rax,4), %ymm6
	vmovups	192(%rcx,%rax,4), %ymm7
	vmovups	224(%rcx,%rax,4), %ymm8
	vmulps	128(%rdi,%rax,4), %ymm5, %ymm5
	vaddps	%ymm5, %ymm1, %ymm1
	vmulps	160(%rdi,%rax,4), %ymm6, %ymm5
	vaddps	%ymm5, %ymm3, %ymm3
	vmulps	192(%rdi,%rax,4), %ymm7, %ymm5
	vaddps	%ymm5, %ymm2, %ymm2
	vmulps	224(%rdi,%rax,4), %ymm8, %ymm5
	vaddps	%ymm5, %ymm4, %ymm4
	addq	$64, %rax
	cmpq	$1024, %rax                     # imm = 0x400
	jne	.LBB6_17
...
.LBB6_30:                               # %vector.body291
	...
	vmovups	32(%rsi,%rdx,4), %ymm7
	vmovups	64(%rsi,%rdx,4), %ymm8
	vmovups	96(%rsi,%rdx,4), %ymm9
	vmulps	(%rcx,%rdx,4), %ymm6, %ymm6
	vmulps	32(%rcx,%rdx,4), %ymm7, %ymm7
	vaddps	%ymm6, %ymm2, %ymm2
	vaddps	%ymm7, %ymm4, %ymm4
	vmulps	64(%rcx,%rdx,4), %ymm8, %ymm6
	vmulps	96(%rcx,%rdx,4), %ymm9, %ymm7
	vaddps	%ymm6, %ymm3, %ymm3
	vaddps	%ymm7, %ymm5, %ymm5
	vmovups	128(%rsi,%rdx,4), %ymm6
	vmovups	160(%rsi,%rdx,4), %ymm7
	vmovups	192(%rsi,%rdx,4), %ymm8
	vmovups	224(%rsi,%rdx,4), %ymm9
	vmulps	128(%rcx,%rdx,4), %ymm6, %ymm6
	vaddps	%ymm6, %ymm2, %ymm2
	vmulps	160(%rcx,%rdx,4), %ymm7, %ymm6
	vaddps	%ymm6, %ymm4, %ymm4
	vmulps	192(%rcx,%rdx,4), %ymm8, %ymm6
	vaddps	%ymm6, %ymm3, %ymm3
	vmulps	224(%rcx,%rdx,4), %ymm9, %ymm6

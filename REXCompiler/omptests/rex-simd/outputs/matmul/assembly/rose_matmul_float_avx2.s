...
.LBB2_3:                                # %for.body6
	...
	vmovups	32(%r11,%rcx,4), %ymm1
	vmovups	64(%r11,%rcx,4), %ymm2
	vmovups	96(%r11,%rcx,4), %ymm3
	vmovups	128(%r11,%rcx,4), %ymm4
	vmulps	32(%rax,%rcx,4), %ymm1, %ymm1
	vmulps	64(%rax,%rcx,4), %ymm2, %ymm2
	vaddps	%ymm1, %ymm0, %ymm0
	vaddps	%ymm2, %ymm0, %ymm0
	vmulps	96(%rax,%rcx,4), %ymm3, %ymm1
	vmulps	128(%rax,%rcx,4), %ymm4, %ymm2
	vaddps	%ymm1, %ymm0, %ymm0
	vaddps	%ymm2, %ymm0, %ymm0
	vmovups	160(%r11,%rcx,4), %ymm1
	vmulps	160(%rax,%rcx,4), %ymm1, %ymm1
	vaddps	%ymm1, %ymm0, %ymm0
	vmovups	192(%r11,%rcx,4), %ymm1
	vmulps	192(%rax,%rcx,4), %ymm1, %ymm1
	vaddps	%ymm1, %ymm0, %ymm0
	vmovups	224(%r11,%rcx,4), %ymm1
	vmulps	224(%rax,%rcx,4), %ymm1, %ymm1
	vmovups	256(%r11,%rcx,4), %ymm2
	vaddps	%ymm1, %ymm0, %ymm0
	vmulps	256(%rax,%rcx,4), %ymm2, %ymm1
	vaddps	%ymm1, %ymm0, %ymm0
	addq	$64, %rcx
...
.LBB6_17:                               # %for.body6.i
                                        ...
                                        # =>    This Inner Loop Header: Depth=3
	vmovups	32(%rcx,%rbp,4), %ymm1
	vmovups	64(%rcx,%rbp,4), %ymm2
	vmovups	96(%rcx,%rbp,4), %ymm3
	vmovups	128(%rcx,%rbp,4), %ymm4
	vmulps	32(%rdi,%rbp,4), %ymm1, %ymm1
	vmulps	64(%rdi,%rbp,4), %ymm2, %ymm2
	vaddps	%ymm1, %ymm0, %ymm0
	vaddps	%ymm2, %ymm0, %ymm0
	vmulps	96(%rdi,%rbp,4), %ymm3, %ymm1
	vmulps	128(%rdi,%rbp,4), %ymm4, %ymm2
	vaddps	%ymm1, %ymm0, %ymm0
	vaddps	%ymm2, %ymm0, %ymm0
	vmovups	160(%rcx,%rbp,4), %ymm1
	vmulps	160(%rdi,%rbp,4), %ymm1, %ymm1
	vaddps	%ymm1, %ymm0, %ymm0
	vmovups	192(%rcx,%rbp,4), %ymm1
	vmulps	192(%rdi,%rbp,4), %ymm1, %ymm1
	vaddps	%ymm1, %ymm0, %ymm0
	vmovups	224(%rcx,%rbp,4), %ymm1
	vmulps	224(%rdi,%rbp,4), %ymm1, %ymm1
	vmovups	256(%rcx,%rbp,4), %ymm2
	vaddps	%ymm1, %ymm0, %ymm0
	vmulps	256(%rdi,%rbp,4), %ymm2, %ymm1
	vaddps	%ymm1, %ymm0, %ymm0
	addq	$64, %rbp
...
.LBB6_30:                               # %for.body6.i210
	...
	vmovups	64(%rsi,%rcx,4), %ymm3
	vmovups	96(%rsi,%rcx,4), %ymm4
	vmovups	128(%rsi,%rcx,4), %ymm5
	vmulps	32(%rbp,%rcx,4), %ymm2, %ymm2
	vmulps	64(%rbp,%rcx,4), %ymm3, %ymm3
	vaddps	%ymm2, %ymm1, %ymm1
	vaddps	%ymm3, %ymm1, %ymm1
	vmulps	96(%rbp,%rcx,4), %ymm4, %ymm2
	vmulps	128(%rbp,%rcx,4), %ymm5, %ymm3
	vaddps	%ymm2, %ymm1, %ymm1
	vaddps	%ymm3, %ymm1, %ymm1
	vmovups	160(%rsi,%rcx,4), %ymm2
	vmulps	160(%rbp,%rcx,4), %ymm2, %ymm2
	vaddps	%ymm2, %ymm1, %ymm1
	vmovups	192(%rsi,%rcx,4), %ymm2
	vmulps	192(%rbp,%rcx,4), %ymm2, %ymm2
	vaddps	%ymm2, %ymm1, %ymm1
	vmovups	224(%rsi,%rcx,4), %ymm2
	vmulps	224(%rbp,%rcx,4), %ymm2, %ymm2
	vmovups	256(%rsi,%rcx,4), %ymm3
	vaddps	%ymm2, %ymm1, %ymm1
	vmulps	256(%rbp,%rcx,4), %ymm3, %ymm2
	vaddps	%ymm2, %ymm1, %ymm1
	addq	$64, %rcx
	cmpq	$1016, %rcx                     # imm = 0x3F8
	jb	.LBB6_30
# %bb.31:                               # %for.end.i217
	...
	cmpq	$1024, %rax                     # imm = 0x400
	jne	.LBB6_29
# %bb.32:                               # %for.inc28.i220
                                        #   in Loop: Header=BB6_28 Depth=2
	incq	%rdx
	cmpq	$1024, %rdx                     # imm = 0x400
	jne	.LBB6_28
# %bb.33:                               # %matmul_simd.exit221
...
# %bb.34:                               # %for.end51
	...
	xorl	%r9d, %r9d
	.p2align	4, 0x90
.LBB6_35:                               # %for.cond1.preheader.i241.preheader
                                        # =>This Loop Header: Depth=1
	...
	xorl	%edx, %edx
	.p2align	4, 0x90
.LBB6_36:                               # %for.cond1.preheader.i241
	...
	xorl	%eax, %eax
	.p2align	4, 0x90
.LBB6_37:                               # %for.cond4.preheader.i244
                                        #   Parent Loop BB6_35 Depth=1
...
# %bb.39:                               # %for.end.i257
	...
	cmpq	$1024, %rax                     # imm = 0x400
	jne	.LBB6_37
# %bb.40:                               # %for.inc20.i260
                                        #   in Loop: Header=BB6_36 Depth=2
	incq	%rdx
	cmpq	$1024, %rdx                     # imm = 0x400
	jne	.LBB6_36
# %bb.41:                               # %matmul_serial.exit261

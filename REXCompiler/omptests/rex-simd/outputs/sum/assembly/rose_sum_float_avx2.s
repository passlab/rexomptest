...
.LBB2_1:                                # %for.body
                                        # =>This Inner Loop Header: Depth=1
	vaddps	32(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	64(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	96(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	128(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	160(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	192(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	224(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	256(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	288(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	320(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	352(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	384(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	416(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	448(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	480(%rdi,%rax,4), %ymm0, %ymm0
	vaddps	512(%rdi,%rax,4), %ymm0, %ymm0
	subq	$-128, %rax
...
.LBB5_41:                               # %for.body.i120.19
                                        # =>This Inner Loop Header: Depth=1
	vaddps	32(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	64(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	96(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	128(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	160(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	192(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	224(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	256(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	288(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	320(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	352(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	384(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	416(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	448(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	480(%rbx,%rax,4), %ymm0, %ymm0
	vaddps	512(%rbx,%rax,4), %ymm0, %ymm0
	subq	$-128, %rax
	cmpq	$10239992, %rax                 # imm = 0x9C3FF8
	jb	.LBB5_41

...
float sum(float *X)
{
  ...
  _mm256_storeu_ps(Y,__buf1);
  
  __m256 __buf2 = _mm256_loadu_ps(&Y[0]);
  __m256 __buf3 = _mm256_loadu_ps(&Y[4]);
  __m256 __buf4 = _mm256_add_ps(__buf2,__buf3);
  
  float *Z = (malloc(sizeof(float ) * 8));
  _mm256_storeu_ps(Z,__buf4);
  __m256 __buf5 = _mm256_loadu_ps(&Z[0]);
  __m256 __buf6 = _mm256_loadu_ps(&Z[2]);
  __m256 __buf7 = _mm256_add_ps(__buf5,__buf6);
  
  float *H = (malloc(sizeof(float ) * 8));
  _mm256_storeu_ps(H,__buf7);
  __m256 __buf8 = _mm256_loadu_ps(&H[0]);
  __m256 __buf9 = _mm256_loadu_ps(&H[1]);
  __m256 __buf10 = _mm256_add_ps(__buf8,__buf9);

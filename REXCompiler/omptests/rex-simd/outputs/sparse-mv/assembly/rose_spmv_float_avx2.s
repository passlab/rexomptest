...
# %bb.39:
	xorl	%eax, %eax
.LBB2_40:                               # %for.end121.loopexit.unr-lcssa
	testb	$1, %r14b
	je	.LBB2_45
...
.LBB2_43:                               # %for.body100.epil
                                        # =>This Inner Loop Header: Depth=1
	vmovups	(%r15,%rdx,4), %ymm1
	vxorps	%xmm2, %xmm2, %xmm2
	kxorw	%k0, %k0, %k1
	vgatherdps	(%r12,%ymm1,4), %ymm2 {%k1}
	vmulps	(%rbx,%rdx,4), %ymm2, %ymm1
...
.LBB2_53:                               # %for.body100.1
	...
	vxorps	%xmm2, %xmm2, %xmm2
	vgatherdps	(%r12,%ymm1,4), %ymm2 {%k1}
	vmulps	(%rbx,%rdi,4), %ymm2, %ymm1
	vaddps	%ymm1, %ymm0, %ymm0
	addq	$8, %rdi
	cmpq	%rbp, %rdi
	jl	.LBB2_53
	jmp	.LBB2_54
.LBB2_57:                               # %vector.ph318
	movl	%r14d, %eax
	andl	$-32, %eax
	leaq	-32(%rax), %rdx
	movq	%rdx, %rcx
...
.LBB2_60:                               # %vector.body316
	...
	addq	$2, %rsi
	jne	.LBB2_60
# %bb.61:                               # %middle.block314.unr-lcssa
	testb	$1, %cl
	je	.LBB2_63
.LBB2_62:                               # %vector.body316.epil
...
.LBB2_63:                               # %middle.block314
	...
	cmpq	%r14, %rax
	je	.LBB2_66
.LBB2_64:                               # %for.body128.preheader333

...
.LBB7_6:                                # %vector.body
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	vmovdqu	-224(%rbx,%rdx,4), %ymm4
	vmovdqu	-192(%rbx,%rdx,4), %ymm5
	vmovdqu	-160(%rbx,%rdx,4), %ymm6
	vmovdqu	-128(%rbx,%rdx,4), %ymm7
	vpmulld	-224(%rcx,%rdx,4), %ymm4, %ymm4
	vpmulld	-192(%rcx,%rdx,4), %ymm5, %ymm5
	vpaddd	%ymm0, %ymm4, %ymm0
	vpaddd	%ymm1, %ymm5, %ymm1
	vpmulld	-160(%rcx,%rdx,4), %ymm6, %ymm4
	vpaddd	%ymm2, %ymm4, %ymm2
	vpmulld	-128(%rcx,%rdx,4), %ymm7, %ymm4
	vpaddd	%ymm3, %ymm4, %ymm3
	vmovdqu	-96(%rbx,%rdx,4), %ymm4
	vmovdqu	-64(%rbx,%rdx,4), %ymm5
	vmovdqu	-32(%rbx,%rdx,4), %ymm6
	vmovdqu	(%rbx,%rdx,4), %ymm7
	vpmulld	-96(%rcx,%rdx,4), %ymm4, %ymm4
	vpmulld	-64(%rcx,%rdx,4), %ymm5, %ymm5
	vpaddd	%ymm0, %ymm4, %ymm0
	vpaddd	%ymm1, %ymm5, %ymm1
	vpmulld	-32(%rcx,%rdx,4), %ymm6, %ymm4
	vpaddd	%ymm2, %ymm4, %ymm2
	vpmulld	(%rcx,%rdx,4), %ymm7, %ymm4
	vpaddd	%ymm3, %ymm4, %ymm3
	addq	$64, %rdx

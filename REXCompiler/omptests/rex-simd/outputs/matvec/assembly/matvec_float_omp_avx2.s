...
.LBB2_2:                                # %vector.body
	...
	vmovups	-192(%rdi,%rcx,4), %ymm6
	vmovups	-160(%rdi,%rcx,4), %ymm7
	vmovups	-128(%rdi,%rcx,4), %ymm8
	vmulps	-224(%rsi,%rcx,4), %ymm5, %ymm5
	vmulps	-192(%rsi,%rcx,4), %ymm6, %ymm6
	vaddps	%ymm5, %ymm1, %ymm1
	vaddps	%ymm6, %ymm3, %ymm3
	vmulps	-160(%rsi,%rcx,4), %ymm7, %ymm5
	vmulps	-128(%rsi,%rcx,4), %ymm8, %ymm6
	...
	vmulps	-96(%rsi,%rcx,4), %ymm5, %ymm5
	vaddps	%ymm5, %ymm1, %ymm1
	vmulps	-64(%rsi,%rcx,4), %ymm6, %ymm5
	vaddps	%ymm5, %ymm3, %ymm3
	vmulps	-32(%rsi,%rcx,4), %ymm7, %ymm5
	vaddps	%ymm5, %ymm2, %ymm2
	vmulps	(%rsi,%rcx,4), %ymm8, %ymm5
...
.LBB7_6:                                # %vector.body
                                        ...
                                        # =>  This Inner Loop Header: Depth=2
	vmovups	-224(%rcx,%rdx,4), %ymm5
	vmovups	-192(%rcx,%rdx,4), %ymm6
	vmovups	-160(%rcx,%rdx,4), %ymm7
	vmovups	-128(%rcx,%rdx,4), %ymm8
	vmulps	-224(%rbx,%rdx,4), %ymm5, %ymm5
	vmulps	-192(%rbx,%rdx,4), %ymm6, %ymm6
	vaddps	%ymm5, %ymm1, %ymm1
	vaddps	%ymm6, %ymm3, %ymm3
	vmulps	-160(%rbx,%rdx,4), %ymm7, %ymm5
	vmulps	-128(%rbx,%rdx,4), %ymm8, %ymm6
	vaddps	%ymm5, %ymm2, %ymm2
	vaddps	%ymm6, %ymm4, %ymm4
	vmovups	-96(%rcx,%rdx,4), %ymm5
	vmovups	-64(%rcx,%rdx,4), %ymm6
	vmovups	-32(%rcx,%rdx,4), %ymm7
	vmovups	(%rcx,%rdx,4), %ymm8
	vmulps	-96(%rbx,%rdx,4), %ymm5, %ymm5
	vaddps	%ymm5, %ymm1, %ymm1
	vmulps	-64(%rbx,%rdx,4), %ymm6, %ymm5
	vaddps	%ymm5, %ymm3, %ymm3
	vmulps	-32(%rbx,%rdx,4), %ymm7, %ymm5
	vaddps	%ymm5, %ymm2, %ymm2
	vmulps	(%rbx,%rdx,4), %ymm8, %ymm5
	vaddps	%ymm5, %ymm4, %ymm4
	addq	$64, %rdx
	cmpq	$10296, %rdx                    # imm = 0x2838
	jne	.LBB7_6
# %bb.7:                                # %middle.block
...
.LBB7_11:                               # %vector.body149
	...
	vmovups	-224(%rdx,%rdi,4), %ymm6
	vmovups	-192(%rdx,%rdi,4), %ymm7
	vmovups	-160(%rdx,%rdi,4), %ymm8
	vmovups	-128(%rdx,%rdi,4), %ymm9
	vmulps	-224(%rbx,%rdi,4), %ymm6, %ymm6
	vmulps	-192(%rbx,%rdi,4), %ymm7, %ymm7
	vaddps	%ymm6, %ymm2, %ymm2
	vaddps	%ymm7, %ymm4, %ymm4
	vmulps	-160(%rbx,%rdi,4), %ymm8, %ymm6
	vmulps	-128(%rbx,%rdi,4), %ymm9, %ymm7
	vaddps	%ymm6, %ymm3, %ymm3
	vaddps	%ymm7, %ymm5, %ymm5
	vmovups	-96(%rdx,%rdi,4), %ymm6
	vmovups	-64(%rdx,%rdi,4), %ymm7
	vmovups	-32(%rdx,%rdi,4), %ymm8
	vmovups	(%rdx,%rdi,4), %ymm9
	vmulps	-96(%rbx,%rdi,4), %ymm6, %ymm6
	vaddps	%ymm6, %ymm2, %ymm2
	vmulps	-64(%rbx,%rdi,4), %ymm7, %ymm6
	vaddps	%ymm6, %ymm4, %ymm4
	vmulps	-32(%rbx,%rdi,4), %ymm8, %ymm6
	vaddps	%ymm6, %ymm3, %ymm3
	vmulps	(%rbx,%rdi,4), %ymm9, %ymm6

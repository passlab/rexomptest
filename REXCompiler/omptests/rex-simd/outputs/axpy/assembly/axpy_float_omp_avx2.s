...
.LBB6_3:                                # %vector.body
	...
	vaddps	-192(%r15,%rax,4), %ymm1, %ymm1
	vaddps	-160(%r15,%rax,4), %ymm2, %ymm2
	vaddps	-128(%r15,%rax,4), %ymm3, %ymm3
	vmovups	%ymm0, -224(%r15,%rax,4)
	vmovups	%ymm1, -192(%r15,%rax,4)
	vmovups	%ymm2, -160(%r15,%rax,4)
	vmovups	%ymm3, -128(%r15,%rax,4)
	...
	vaddps	-64(%r15,%rax,4), %ymm1, %ymm1
	vaddps	-32(%r15,%rax,4), %ymm2, %ymm2
	vaddps	(%r15,%rax,4), %ymm3, %ymm3
	vmovups	%ymm0, -96(%r15,%rax,4)
	vmovups	%ymm1, -64(%r15,%rax,4)
	vmovups	%ymm2, -32(%r15,%rax,4)
	vmovups	%ymm3, (%r15,%rax,4)
	addq	$64, %rax
	cmpq	$102400056, %rax                # imm = 0x61A8038
	jne	.LBB6_3
# %bb.4:                                # %vector.body203.preheader
	movl	$56, %eax
	.p2align	4, 0x90
.LBB6_5:                                # %vector.body203
                                        # =>This Inner Loop Header: Depth=1
	vmulps	-224(%r14,%rax,4), %ymm4, %ymm0
	vmulps	-192(%r14,%rax,4), %ymm4, %ymm1
	vmulps	-160(%r14,%rax,4), %ymm4, %ymm2
...
.LBB6_10:                               # %vector.body219
	...
	vaddps	-192(%r15,%rdx,4), %ymm2, %ymm2
	vaddps	-160(%r15,%rdx,4), %ymm3, %ymm3
	vaddps	-128(%r15,%rdx,4), %ymm4, %ymm4
	vmovups	%ymm1, -224(%r15,%rdx,4)
	vmovups	%ymm2, -192(%r15,%rdx,4)
	vmovups	%ymm3, -160(%r15,%rdx,4)
	vmovups	%ymm4, -128(%r15,%rdx,4)
	...
	vaddps	-32(%r15,%rdx,4), %ymm3, %ymm3
	vaddps	(%r15,%rdx,4), %ymm4, %ymm4
	vmovups	%ymm1, -96(%r15,%rdx,4)
	vmovups	%ymm2, -64(%r15,%rdx,4)
	vmovups	%ymm3, -32(%r15,%rdx,4)
	vmovups	%ymm4, (%r15,%rdx,4)
	addq	$64, %rdx
...
# %bb.12:                               # %for.cond.cleanup28
	...
	xorl	%ecx, %ecx
	.p2align	4, 0x90
.LBB6_13:                               # %vector.ph236
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB6_14 Depth 2
	movl	$56, %edx
	.p2align	4, 0x90
.LBB6_14:                               # %vector.body235

...
.LBB6_3:                                # %vector.body
	...
	vmovdqu	%ymm0, -224(%r15,%rax,4)
	vmovdqu	%ymm1, -192(%r15,%rax,4)
	vmovdqu	%ymm2, -160(%r15,%rax,4)
	vmovdqu	%ymm3, -128(%r15,%rax,4)
	...
	vmovdqu	%ymm0, -96(%r15,%rax,4)
	vmovdqu	%ymm1, -64(%r15,%rax,4)
	vmovdqu	%ymm2, -32(%r15,%rax,4)
	vmovdqu	%ymm3, (%r15,%rax,4)
	addq	$64, %rax
	cmpq	$102400056, %rax                # imm = 0x61A8038
	jne	.LBB6_3
# %bb.4:                                # %vector.body198.preheader
	movl	$56, %eax
	.p2align	4, 0x90
.LBB6_5:                                # %vector.body198
                                        # =>This Inner Loop Header: Depth=1
	vpmulld	-224(%r14,%rax,4), %ymm4, %ymm0
	vpmulld	-192(%r14,%rax,4), %ymm4, %ymm1
	vpmulld	-160(%r14,%rax,4), %ymm4, %ymm2
...
.LBB6_10:                               # %vector.body214
	...
	vpaddd	-224(%r15,%rdx,4), %ymm1, %ymm1
	vpaddd	-192(%r15,%rdx,4), %ymm2, %ymm2
	vpaddd	-160(%r15,%rdx,4), %ymm3, %ymm3
	vpaddd	-128(%r15,%rdx,4), %ymm4, %ymm4
	vmovdqu	%ymm1, -224(%r15,%rdx,4)
	vmovdqu	%ymm2, -192(%r15,%rdx,4)
	vmovdqu	%ymm3, -160(%r15,%rdx,4)
	vmovdqu	%ymm4, -128(%r15,%rdx,4)
	vpmulld	-96(%r14,%rdx,4), %ymm5, %ymm1
	vpmulld	-64(%r14,%rdx,4), %ymm5, %ymm2
	vpmulld	-32(%r14,%rdx,4), %ymm5, %ymm3
	vpmulld	(%r14,%rdx,4), %ymm5, %ymm4
	vpaddd	-96(%r15,%rdx,4), %ymm1, %ymm1
	vpaddd	-64(%r15,%rdx,4), %ymm2, %ymm2
	vpaddd	-32(%r15,%rdx,4), %ymm3, %ymm3
	vpaddd	(%r15,%rdx,4), %ymm4, %ymm4
	vmovdqu	%ymm1, -96(%r15,%rdx,4)
	vmovdqu	%ymm2, -64(%r15,%rdx,4)
	vmovdqu	%ymm3, -32(%r15,%rdx,4)
	vmovdqu	%ymm4, (%r15,%rdx,4)
	addq	$64, %rdx
...
# %bb.12:                               # %for.cond.cleanup27
	...
	xorl	%ecx, %ecx
	.p2align	4, 0x90
.LBB6_13:                               # %vector.ph231
                                        # =>This Loop Header: Depth=1
                                        #     Child Loop BB6_14 Depth 2
	movl	$56, %edx
	.p2align	4, 0x90
.LBB6_14:                               # %vector.body230

...
extern void OUT__1__3684__matmul_simd__37__(int *__global_tid,int *__bound_tid,float ***Ap__,float ***Bp__,float ***Cp__,int *ip__,float *tempp__);
...
void matmul_simd(float **A,float **B,float **C)
{
  ...
  float temp;
  for (i = 0; i < 1024; i++) {
    void *__out_argv1__3684__[5];
    __out_argv1__3684__[0] = ((void *)(&temp));
    __out_argv1__3684__[1] = ((void *)(&i));
    __out_argv1__3684__[2] = ((void *)(&C));
    __out_argv1__3684__[3] = ((void *)(&B));
    __out_argv1__3684__[4] = ((void *)(&A));
    __kmpc_fork_call(0,5,OUT__1__3684__matmul_simd__37__,&A,&B,&C,&i,&temp);
  }
}

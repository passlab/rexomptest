  ...
  for (size_t i = 0; i < 1024; i++) {
    for (size_t j = 0; j < 1024; j++) {
      ...
      for (k = 0; k <= ((unsigned long )1024) - 1; k += 8 * 16) {
        ...
        __part0 = (__vec6);
        float *__ptr7 = A[i];
        __m512 __vec8 = _mm512_loadu_ps(&__ptr7[k + 16 * 1]);
        float *__ptr9 = B[j];
        __m512 __vec10 = _mm512_loadu_ps(&__ptr9[k + 16 * 1]);
        __m512 __vec11 = _mm512_mul_ps(__vec10,__vec8);
        __m512 __vec12 = _mm512_add_ps(__vec11,__part0);
        __part0 = (__vec12);
        float *__ptr13 = A[i];
        __m512 __vec14 = _mm512_loadu_ps(&__ptr13[k + 16 * 2]);
        float *__ptr15 = B[j];
        ...
        __part0 = (__vec18);
        float *__ptr19 = A[i];
        __m512 __vec20 = _mm512_loadu_ps(&__ptr19[k + 16 * 3]);
        float *__ptr21 = B[j];
        __m512 __vec22 = _mm512_loadu_ps(&__ptr21[k + 16 * 3]);
        __m512 __vec23 = _mm512_mul_ps(__vec22,__vec20);
        __m512 __vec24 = _mm512_add_ps(__vec23,__part0);
        __part0 = (__vec24);
        float *__ptr25 = A[i];
        __m512 __vec26 = _mm512_loadu_ps(&__ptr25[k + 16 * 4]);
        float *__ptr27 = B[j];
        __m512 __vec28 = _mm512_loadu_ps(&__ptr27[k + 16 * 4]);
        __m512 __vec29 = _mm512_mul_ps(__vec28,__vec26);
        __m512 __vec30 = _mm512_add_ps(__vec29,__part0);
        __part0 = (__vec30);
        float *__ptr31 = A[i];
        __m512 __vec32 = _mm512_loadu_ps(&__ptr31[k + 16 * 5]);
        float *__ptr33 = B[j];
        __m512 __vec34 = _mm512_loadu_ps(&__ptr33[k + 16 * 5]);
        __m512 __vec35 = _mm512_mul_ps(__vec34,__vec32);
        __m512 __vec36 = _mm512_add_ps(__vec35,__part0);
        __part0 = (__vec36);
        float *__ptr37 = A[i];
        __m512 __vec38 = _mm512_loadu_ps(&__ptr37[k + 16 * 6]);
        float *__ptr39 = B[j];
        __m512 __vec40 = _mm512_loadu_ps(&__ptr39[k + 16 * 6]);
        __m512 __vec41 = _mm512_mul_ps(__vec40,__vec38);
        __m512 __vec42 = _mm512_add_ps(__vec41,__part0);
        __part0 = (__vec42);
        float *__ptr43 = A[i];
        __m512 __vec44 = _mm512_loadu_ps(&__ptr43[k + 16 * 7]);
        float *__ptr45 = B[j];
        __m512 __vec46 = _mm512_loadu_ps(&__ptr45[k + 16 * 7]);
        __m512 __vec47 = _mm512_mul_ps(__vec46,__vec44);
        __m512 __vec48 = _mm512_add_ps(__vec47,__part0);
        __part0 = (__vec48);
      }

...
extern void OUT__1__3684__matmul_simd__34__(int *__global_tid,int *__bound_tid,float ***Ap__,float ***Bp__,float ***Cp__);
...
void matmul_simd(float **A,float **B,float **C)
{
  ...
  __out_argv1__3684__[0] = ((void *)(&C));
  __out_argv1__3684__[1] = ((void *)(&B));
  __out_argv1__3684__[2] = ((void *)(&A));
  __kmpc_fork_call(0,3,OUT__1__3684__matmul_simd__34__,&A,&B,&C);
}

...
extern void OUT__1__3684__matmul_simd__35__(int *__global_tid,int *__bound_tid,float ***Ap__,float ***Bp__,float ***Cp__,float *tempp__);
...
void matmul_simd(float **A,float **B,float **C)
{
  ...
  __kmpc_fork_call(0,4,OUT__1__3684__matmul_simd__35__,&A,&B,&C,&temp);
}

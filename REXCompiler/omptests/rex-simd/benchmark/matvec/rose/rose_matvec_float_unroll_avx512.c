...
void matvec_simd(float *matrix,float *vector,float *dest)
{
  for (size_t i = 0; i < 10240; i++) {
    ...
    for (j = 0; j <= ((unsigned long )10240) - 1; j += 8 * 16) {
      ...
      __part0 = (__vec4);
      __m512 __vec5 = _mm512_loadu_ps(&matrix[i * ((unsigned long )10240) + (j + 16 * 1)]);
      __m512 __vec6 = _mm512_loadu_ps(&vector[j + 16 * 1]);
      __m512 __vec7 = _mm512_mul_ps(__vec6,__vec5);
      __m512 __vec8 = _mm512_add_ps(__vec7,__part0);
      __part0 = (__vec8);
      __m512 __vec9 = _mm512_loadu_ps(&matrix[i * ((unsigned long )10240) + (j + 16 * 2)]);
      __m512 __vec10 = _mm512_loadu_ps(&vector[j + 16 * 2]);
      __m512 __vec11 = _mm512_mul_ps(__vec10,__vec9);
      __m512 __vec12 = _mm512_add_ps(__vec11,__part0);
      __part0 = (__vec12);
      __m512 __vec13 = _mm512_loadu_ps(&matrix[i * ((unsigned long )10240) + (j + 16 * 3)]);
      __m512 __vec14 = _mm512_loadu_ps(&vector[j + 16 * 3]);
      __m512 __vec15 = _mm512_mul_ps(__vec14,__vec13);
      __m512 __vec16 = _mm512_add_ps(__vec15,__part0);
      __part0 = (__vec16);
      __m512 __vec17 = _mm512_loadu_ps(&matrix[i * ((unsigned long )10240) + (j + 16 * 4)]);
      __m512 __vec18 = _mm512_loadu_ps(&vector[j + 16 * 4]);
      __m512 __vec19 = _mm512_mul_ps(__vec18,__vec17);
      __m512 __vec20 = _mm512_add_ps(__vec19,__part0);
      __part0 = (__vec20);
      __m512 __vec21 = _mm512_loadu_ps(&matrix[i * ((unsigned long )10240) + (j + 16 * 5)]);
      __m512 __vec22 = _mm512_loadu_ps(&vector[j + 16 * 5]);
      __m512 __vec23 = _mm512_mul_ps(__vec22,__vec21);
      __m512 __vec24 = _mm512_add_ps(__vec23,__part0);
      __part0 = (__vec24);
      __m512 __vec25 = _mm512_loadu_ps(&matrix[i * ((unsigned long )10240) + (j + 16 * 6)]);
      __m512 __vec26 = _mm512_loadu_ps(&vector[j + 16 * 6]);
      __m512 __vec27 = _mm512_mul_ps(__vec26,__vec25);
      __m512 __vec28 = _mm512_add_ps(__vec27,__part0);
      __part0 = (__vec28);
      __m512 __vec29 = _mm512_loadu_ps(&matrix[i * ((unsigned long )10240) + (j + 16 * 7)]);
      __m512 __vec30 = _mm512_loadu_ps(&vector[j + 16 * 7]);

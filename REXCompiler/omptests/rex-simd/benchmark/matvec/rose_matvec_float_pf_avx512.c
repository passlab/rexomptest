...
extern void OUT__1__3684__matvec_simd__30__(int *__global_tid,int *__bound_tid,float **matrixp__,float **vectorp__,float **destp__,int *jp__);

void matvec_simd(float *matrix,float *vector,float *dest)
{
  int i;
  int j;
  void *__out_argv1__3684__[4];
  __out_argv1__3684__[0] = ((void *)(&j));
  __out_argv1__3684__[1] = ((void *)(&dest));
  __out_argv1__3684__[2] = ((void *)(&vector));
  __out_argv1__3684__[3] = ((void *)(&matrix));
  __kmpc_fork_call(0,4,OUT__1__3684__matvec_simd__30__,&matrix,&vector,&dest,&j);
}
// Debug functions

...
extern void OUT__1__8635__lud_omp__57__(int *__global_tid,int *__bound_tid);
extern void OUT__2__8635__lud_omp__111__(int *__global_tid,int *__bound_tid);
...
// 
    __kmpc_fork_call(0,0,OUT__1__8635__lud_omp__57__,0);
// update interior block matrices
//
    chunks_per_inter = chunks_in_inter_row * chunks_in_inter_row;
    __kmpc_fork_call(0,0,OUT__2__8635__lud_omp__111__,0);
  }
  lud_diagonal_omp(a,size,offset);
#ifdef OMP_OFFLOAD
#endif

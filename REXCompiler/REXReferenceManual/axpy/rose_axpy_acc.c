#include "rex_kmp.h" 
char OUT__1__5325__axpy__45__id__ = 0;
struct __tgt_offload_entry OUT__1__5325__axpy__45__omp_offload_entry__ __attribute__((section("omp_offloading_entries")))  = {((void *)(&OUT__1__5325__axpy__45__id__)), "OUT__1__5325__axpy__45__kernel__", 0, 0, 0};
...
/* Launch CUDA kernel ... */
    ...
    void *__host_ptr = (void *)(&OUT__1__5325__axpy__45__id__);
    void *__args_base[] = {&n, &a, x, y};
    void *__args[] = {&n, &a, x + 0, y + 0};
    int64_t __arg_sizes[] = {((int64_t )(sizeof(long ) * 1)), ((int64_t )(sizeof(double ) * 1)), ((int64_t )(sizeof(double ) * n)), ((int64_t )(sizeof(double ) * n))};
    int64_t __arg_types[] = {33, 33, 33, 34};
    int32_t __arg_num = 4;

#include "rex_kmp.h" 
char OUT__1__7655__foo__7__id__ = 0;
struct __tgt_offload_entry OUT__1__7655__foo__7__omp_offload_entry__ __attribute__((section("omp_offloading_entries")))  = {((void *)(&OUT__1__7655__foo__7__id__)), "OUT__1__7655__foo__7__kernel__", 0, 0, 0};
#include <stdio.h>
#include <stdlib.h>
